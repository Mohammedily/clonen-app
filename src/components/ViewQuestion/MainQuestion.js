...
//https://xsdeee.herokuapp.com/api/question/
///api/comment/${id}
...
///api/question/${id}
  useEffect(() => {
    async function getFunctionDetails() {
      await axios
        .get(`https://xsdeee.herokuapp.com/api/question/${id}`)
  ...
  const handleSubmit = async () => {
    ...
    await axios
      .post(`https://xsdeee.herokuapp.com/api/comment/${id}`, body, config)
      .then(() => {
  ...
  const handleComment = async () => {
    if (comment !== "") {
      ...
      await axios.post(`https://xsdeee.herokuapp.com/api/question/`, body).then((res) => {
        setComment("");
        setShow(false);
        getUpdatedAnswer();
